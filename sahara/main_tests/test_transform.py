...
tr = svg.rect(100, 100, 40, 40, fill='#80f').transform.translate(420)
...
svg.rect(100, 100, 40, 40, fill='#0ff').transform.rotate(90, 370, 230).transform(cairo.Matrix(1,0,0,1,280,0))
...
svg.rect(100, 100, 40, 40, fill='#8f0').transform(tr.copy().translate(-500, 440)).skewX(45)
