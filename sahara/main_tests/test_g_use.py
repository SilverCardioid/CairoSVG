...
path1 = g1.add_child('path', id='path1', d='M75,15 135,75 75,135 15,75z')
g1.add_child('use', href='#path1', transform='translate(150,0)')
g1.add_child('use', href='path1',  transform='translate(0,150)',   fill='#084')
g1.add_child('use', href=path1,    transform='translate(150,150)', fill='#084')
